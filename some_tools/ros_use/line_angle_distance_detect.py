...
weight_path_angle = "/home/austin/trailnet-testing-Pytorch/duckiefloat_line_follow/src/line_detect/src/line_angle_71.pth"
weight_path_distance = "/home/austin/trailnet-testing-Pytorch/duckiefloat_line_follow/src/line_detect/src/line_center_83.pth"
    ...
    def c_pose(self, data):
        ...
        if self.count == 1:
            ...
            try:
                ...
                current_pose = [self.distance,self.angle]
                target_pose = [0,0]
